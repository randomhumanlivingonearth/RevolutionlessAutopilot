...
namespace RevolutionlessAutopilot
{
    public static class GUI
    {
        ...
        private static SFS.UI.ModGUI.Button ascentToggleButton;
        ...
        public static void HideGUI()
        {
            ...
            landingHolder = null;
            landingWindow = null;
            targetAltitudeInput = null;
            ascentToggleButton = null;
            landingButton = null;
            consoleRow = null;
        }
        ...
        private static void BuildAscentWindow()
        {
            ...
            ascentToggleButton = Builder.CreateButton(ascentWindow, 220, 40, 0, 0, ToggleAscentAutopilot, "Start Ascent");
            RefreshAscentToggleButtonLabel();
        }
        ...
        public static void RefreshAscentToggleButtonLabel()
        {
            if (ascentToggleButton == null)
                return;

            GameObject buttonObject = ascentToggleButton.gameObject;
            if (buttonObject == null)
                return;

            string label = (AutopilotUpdater.Instance != null && AutopilotUpdater.Instance.IsAscentActive)
                ? "Off"
                : "Start Ascent";
